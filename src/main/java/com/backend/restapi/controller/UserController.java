...
public class UserController {
	...
	public ResponseEntity<UserProfileUpdateDto> getMyProfile(
	...
	public ResponseEntity<String> updateUserProfile(@PathVariable("user_id") int userId,
	...
	public ResponseEntity<String> sendOtpEmailChangePassword(@RequestBody RegisterDto registerDto) {
		if (userRepository.existsByEmail(registerDto.getEmail())) {
			try {
				...
				return new ResponseEntity<>("Gửi email OTP thất bại: " + e.getMessage(),
